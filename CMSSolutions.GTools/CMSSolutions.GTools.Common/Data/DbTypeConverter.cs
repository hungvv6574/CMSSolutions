...
namespace CMSSolutions.GTools.Common.Data
{
    ...
    {
        private static PairList<FieldType, DbType> fieldTypes = new PairList<FieldType, DbType>();
        private static PairList<DbType, FieldType> dbTypes = new PairList<DbType, FieldType>();
        ...
        public FieldType GetScaffolderFieldType(DbType providerFieldType)
        {
            return dbTypes.First(x => x.First == providerFieldType).Second;
        }
