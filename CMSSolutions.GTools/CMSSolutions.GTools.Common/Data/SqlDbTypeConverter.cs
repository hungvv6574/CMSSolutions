...
namespace CMSSolutions.GTools.Common.Data
{
    ...
    {
        private static PairList<FieldType, SqlDbType> fieldTypes = new PairList<FieldType, SqlDbType>();
        private static PairList<SqlDbType, FieldType> sqlDbTypes = new PairList<SqlDbType, FieldType>();
        ...
        public FieldType GetScaffolderFieldType(SqlDbType providerFieldType)
        {
            return sqlDbTypes.First(x => x.First == providerFieldType).Second;
        }

        public SqlDbType GetDataProviderFieldType(FieldType fieldType)
        {
            return fieldTypes.First(x => x.First == fieldType).Second;
        }
