...
namespace CMSSolutions.GTools.Common.Data
{
    ...
    {
        private static PairList<Type, FieldType> netTypes = new PairList<Type, FieldType>();
        private static PairList<FieldType, Type> fieldTypes = new PairList<FieldType, Type>();
        ...
        public FieldType GetScaffolderFieldType(Type providerFieldType)
        {
            return netTypes.First(x => x.First == providerFieldType).Second;
        }
