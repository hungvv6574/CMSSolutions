...
namespace CMSSolutions.GTools.Common.Wizard
{
    public partial class WizardHost : UserControl
    {
        ...
        private bool CheckPageIsValid()
        {
            ...
            {
                MessageBox.Show(
                    string.Concat(VALIDATION_MESSAGE, System.Environment.NewLine, System.Environment.NewLine, WizardPages.CurrentPage.ValidationMessage),
                    "Details Required",
        ...
        public void LoadNextPage(int pageIndex, int previousPageIndex, bool savePreviousPage)
        {
            if (pageIndex != -1)
            {
                ...
                WizardPages[pageIndex].Content.Dock = DockStyle.Fill;
